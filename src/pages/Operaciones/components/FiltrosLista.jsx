...
export default function FiltrosOperaciones({filtros, onChange}){
    ...
    return(
        <>
            ...
            {admini && <SelectField label="Supervisor" options={supervisores}  value={filtros.supervisorId ?? ""} name="empleadoId" onChange={handleChange}/>}
            ...
            <SelectField label="Estado de fecha" options={estadossSoat} value={filtros.estadoFecha ?? ""} name="estadoFecha" onChange={handleChange}/>
        </>
    )
}